...
public class FavoriteFragmentDirections {
  ...
  @NonNull
  public static ActionFavoriteFragmentToDetailFragment actionFavoriteFragmentToDetailFragment(
      @NonNull Cerveceria cerveceria) {
    return new ActionFavoriteFragmentToDetailFragment(cerveceria);
  }

  public static class ActionFavoriteFragmentToDetailFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionFavoriteFragmentToDetailFragment(@NonNull Cerveceria cerveceria) {
      if (cerveceria == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavoriteFragmentToDetailFragment setCerveceria(@NonNull Cerveceria cerveceria) {
      if (cerveceria == null) {
        throw new IllegalArgumentException("Argument \"cerveceria\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("cerveceria", cerveceria);
    ...
    public int getActionId() {
      return R.id.action_favoriteFragment_to_detailFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFavoriteFragmentToDetailFragment that = (ActionFavoriteFragmentToDetailFragment) object;
    ...
    public String toString() {
      return "ActionFavoriteFragmentToDetailFragment(actionId=" + getActionId() + "){"
